...
//Say we want to write a program that asks whether your name is longer than 7 letters.
//If the answer is yes, we can respond with "You have a long name!" We can do this with an if statement:
...
if ( 50 > 35 ) {
    console.log("Yes, 50 IS larger than 35... *slow clap*");
}
