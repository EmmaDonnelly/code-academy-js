...
//Remember that each character in a string is numbered starting from 0. So for the
//word "hello", The letter h is in position 0, the letter e is in position 1, and so on.
