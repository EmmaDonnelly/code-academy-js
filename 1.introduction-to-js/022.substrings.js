...
//Sometimes you don't want to display the entire string, just a part of it. For
//example, in your Gmail inbox, you can set it to display the first 50 or so
//characters of each message so you can preview them. This preview is a substring
//of the original string (the entire message).
