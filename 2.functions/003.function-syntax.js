...
//03. The code in the parentheses is called a parameter. It's a placeholder word that we give a specific value when we call the function. Click "Stuck? Get a hint!" for more.
//04. Then write your block of reusable code between { }. Every line of code in this block must end with a ;.
//05. You can run this code by "calling" the function, like this:

  sayHello("Emily");
  Calling this function will print out Hello Emily.

//01. On line 11, call the greeting function and put in a name that you want the greeting function to include.
//02. Press "Save & Submit Code" and see the function get into action! Saves you so much time.
